...
For the sake of demonstration, we're also wiping the database table each time the program runs. **Of course, we wouldn't do this if this was a real application.**
